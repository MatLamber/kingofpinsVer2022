...
namespace MoreMountains.TopDownEngine
{
	...
	public class WeaponAutoAim2D : WeaponAutoAim
	{
		...
		protected override bool ScanForTargets()
		{
			...
			contactFilter.SetLayerMask(TargetsMask);
			contactFilter.useTriggers = true;
			int numberOfResults = Physics2D.OverlapCircle(_raycastOrigin, ScanRadius, contactFilter, _results); 
		...
		protected override void SetAim()
		{
			...
			_aimDirection = (Target.GetComponent<Collider2D>().bounds.center - _raycastOrigin).normalized;
