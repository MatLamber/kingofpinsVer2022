    ...
    public class TTPBilling
    {
        ...
        public static void InitBilling(System.Action<BillerErrors> onBillingInitAction)
        {
            ...
            if(_unityBillingAgent == null) {
                ...
                (string receipt, float price, string currency, string productId, Dictionary<string, object> subscriptionStartedData, bool shouldSendTransactionEvent) => 
                {
                    if (Impl != null)
                    {
                        Impl.ValidateReceiptAndReport(receipt, price, currency, productId, subscriptionStartedData, shouldSendTransactionEvent);
                    }
                },
                NoAdsPurchased,
                (bool success) =>
        ...
        {
            void ValidateReceiptAndReport(string receipt, float price, string currency, string productId, Dictionary<String, object> subscriptionStartedData, bool shouldSendTransactionEvent);
        ...
        private class IosImpl : ITTPBilling
        {
            ...
            private static extern void ttpValidateReceiptAndReport(float price, string currency, string productId, string subscriptionStartedData);
            ...
            public void ValidateReceiptAndReport(string receipt, float price, string currency, string productId, Dictionary<String, object> subscriptionStartedData, bool shouldSendTransactionEvent)
            {
                var eventParams = subscriptionStartedData != null ? TTPJson.Serialize(subscriptionStartedData) : "";
                ttpValidateReceiptAndReport(price, currency, productId, eventParams);
            }
        ...
        private class AndroidImpl : ITTPBilling
        {
            ...
            public void ValidateReceiptAndReport(string receipt, float price, string currency, string productId, Dictionary<string, object> subscriptionStartedData, bool shouldSendTransactionEvent)
            {
                ...
                {
                    var eventParams = subscriptionStartedData != null ? TTPJson.Serialize(subscriptionStartedData) : "";
                    ServiceJavaObject.Call("validateReceiptAndReport",new object[] { receipt, price, currency, productId, eventParams, shouldSendTransactionEvent });
                }
            }
